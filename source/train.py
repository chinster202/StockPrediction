...
def train_model(model, train_loader, val_loader, ticker_path, epochs=config.epochs, lr=config.lr):
    if config.error == "MSE":
    ...
    for epoch in range(epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), f'models/best_stock_model_{ticker_path}.bin')
